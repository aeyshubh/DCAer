...
contract OracleConsumerContract is PhatRollupAnchor {
    event ResponseReceived(address walletAddress,address asset1,uint256 asset1Value,address asset2,uint256 amountOut);
    ...
    function _onMessageReceived(bytes calldata action) internal override {
        ...
        TransferHelper.safeTransferFrom(USDC,walletAddress, address(this), asset1Value);
        ...
        uint256 amountOut = swapRouter.exactInputSingle(params);
            emit ResponseReceived(walletAddress,asset1 ,asset1Value ,asset2,amountOut);
